<?php
namespace Application\ReportBundle\Report;
use \TCPDF;
class ReportPDF extends TCPDF {
    ...
    protected function setupReport() {
        ...
        $this->SetAuthor('Sistema de Preinscripcion - Escuela para la Innovación Educativa');
    ...
    public function Header() {
        ...
        $this->Image($image_file, 30, 20, 160, 30, '', '', '', true, 150);// 10, 10, 15, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        //
        // Set font
    ...
    public function Footer() {
        ...
        $today = new \DateTime();
        $txt = sprintf('Sistema de Preinscripcion - Escuela para la Innovación Educativa - %s - %s',
